import { Flow, FlowDefinition, FlowScreen, FlowInput, FlowAction } from './types';
...
export function validateFlowScreen(screen: FlowScreen): void {
  if (!screen.name) {
...
export function validateFlowInput(input: FlowInput): void {
  if (!input.name) {
...
export function validateFlowAction(action: FlowAction): void {
