...
export type HandlerType = MessageHandler | CallbackHandler | SystemHandler | PhoneNumberChangeHandler | IdentityChangeHandler | StatusHandler | ChatOpenedHandler | UserPreferencesHandler | CallHandler;
