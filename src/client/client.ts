...
import { Handler, onCallback } from '../handlers';
...
export class WhatsAppClient {
  ...
  private webhooks: WebhooksHandler;
   ...
   * @returns Promise resolving to the message response
   */
  async sendTemplate(template: Template): Promise<MessageResponse> {
    try {
   ...
   */
  async deleteMedia(media_id: string): Promise<any> {
    try {
   ...
   */
  async createFlow(flow: Flow): Promise<any> {
    try {
   ...
   */
  async getBusinessPhoneNumbers(): Promise<BusinessPhoneNumber[]> {
    try {
   ...
   */
  async getBusinessPhoneNumberSettings(phone_number_id: string): Promise<any> {
    try {
   ...
   */
  async updateBusinessPhoneNumberSettings(phone_number_id: string, settings: any): Promise<any> {
    try {
   ...
   * @returns Promise resolving to success result
   */
  async updateDisplayName(display_name: string): Promise<any> {
    try {
   ...
   */
  async registerPhoneNumber(phone_number: string): Promise<any> {
    try {
   ...
   */
  async deregisterPhoneNumber(phone_number_id: string): Promise<any> {
    try {
   ...
   * @returns Promise resolving to success result
   */
  async markMessageAsRead(message_id: string, phone_number_id?: string): Promise<any> {
    try {
   ...
   * @returns Promise resolving to success result
   */
  async indicateTyping(phone_number_id: string, to: string): Promise<any> {
    try {
