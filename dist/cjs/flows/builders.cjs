...
exports.action = exports.option = exports.input = exports.screen = exports.flow = exports.FlowActionBuilder = exports.FlowOptionBuilder = exports.FlowInputBuilder = exports.FlowScreenBuilder = exports.FlowBuilder = void 0;
class FlowBuilder {
    constructor() {
        this.flow = {
            name: '',
...
exports.FlowScreenBuilder = FlowScreenBuilder;
class FlowInputBuilder {
    ...
    build() {
        ...
        if (this.input.type === 'dropdown' &&
            (!this.input.options || this.input.options.length === 0)) {
            throw new Error('Dropdown input must have at least one option');
        }
        return { ...this.input };
    }
}
exports.FlowInputBuilder = FlowInputBuilder;
class FlowOptionBuilder {
    constructor() {
        this.option = {
            title: '',
            value: '',
...
exports.FlowOptionBuilder = FlowOptionBuilder;
class FlowActionBuilder {
    constructor() {
        this.action = {
            type: 'next',
        };
...
exports.FlowActionBuilder = FlowActionBuilder;
// Factory functions
const flow = () => new FlowBuilder();
exports.flow = flow;
const screen = () => new FlowScreenBuilder();
exports.screen = screen;
const input = () => new FlowInputBuilder();
exports.input = input;
const option = () => new FlowOptionBuilder();
exports.option = option;
const action = () => new FlowActionBuilder();
