...
export class WhatsAppAPI {
   ...
   */
  async sendMessage(phone_number_id: string, message: any): Promise<any> {
   ...
   * @returns Promise resolving to the message response
   */
  async sendTemplate(phone_number_id: string, template: any): Promise<any> {
    const url = `${this.base_url}/${phone_number_id}/messages`;
    const response = await fetch(url, {
      method: 'POST',
      headers: {
   ...
   */
  async getBusinessPhoneNumbers(): Promise<any[]> {
