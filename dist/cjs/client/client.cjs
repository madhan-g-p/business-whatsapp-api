...
const api_1 = require("./api.cjs");
const webhooks_1 = require("./webhooks.cjs");
...
class WhatsAppClient {
    ...
    constructor(phone_number_id, access_token, app_id, app_secret) {
        ...
        this.api = new api_1.WhatsAppAPI(access_token);
        this.webhooks = new webhooks_1.WebhooksHandler();
        this.auth = new auth_1.Authentication(this.access_token);
    }
    /**
    ...
    async sendMessage(message) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to send message: ${error}`);
        }
    }
    /**
    ...
    async sendTemplate(template) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to send template: ${error}`);
        }
    }
    /**
    ...
    async getMessages(filter) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to get messages: ${error}`);
        }
    }
    /**
    ...
    async uploadMedia(file, phone_number_id) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to upload media: ${error}`);
        }
    }
    /**
    ...
    async deleteMedia(media_id) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to delete media: ${error}`);
        }
    }
    /**
     * Create a new flow
    ...
    async createFlow(flow) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to create flow: ${error}`);
        }
    }
    /**
    ...
    async getBusinessPhoneNumbers() {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to get business phone numbers: ${error}`);
        }
    }
    /**
    ...
    async getBusinessPhoneNumberSettings(phone_number_id) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to get business phone number settings: ${error}`);
        }
    }
    /**
    ...
    async updateBusinessPhoneNumberSettings(phone_number_id, settings) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to update business phone number settings: ${error}`);
        }
    }
    /**
     * Update display name
    ...
    async updateDisplayName(display_name) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to update display name: ${error}`);
        }
    }
    /**
    ...
    async getBusinessAccount() {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to get business account: ${error}`);
        }
    }
    /**
    ...
    async registerPhoneNumber(phone_number) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to register phone number: ${error}`);
        }
    }
    /**
    ...
    async deregisterPhoneNumber(phone_number_id) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to deregister phone number: ${error}`);
        }
    }
    /**
    ...
    async markMessageAsRead(message_id, phone_number_id) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to mark message as read: ${error}`);
        }
    }
    /**
    ...
    async indicateTyping(phone_number_id, to) {
        try {
            ...
            throw new errors_1.WhatsAppError(`Failed to indicate typing: ${error}`);
        }
    }
    /**
